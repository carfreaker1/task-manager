          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                @if (session('successdesig'))
                   {{-- <p class="alert alert-success text-center">{{ session('successdesig') }}</p> --}}
                   <script>
                ...
                @endif
                <form action="{{ route('storedesignation') }}" enctype="multipart/form-data" method="post" id="quickForm">
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="designation" class="form-label">Designation Name</label>
                      <input type="text" class="form-control" id="designation" value="{{ old('designation') }}" name="designation" aria-describedby="emailHelp"
