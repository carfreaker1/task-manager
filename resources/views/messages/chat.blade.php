                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            @elseif (session('successdesig'))
                                {{-- <p class="alert alert-success text-center alert-dismissible">{{ session('successdesig') }}
                                </p> --}}
                                <script>
                                    $(document).ready(function () {
                                        $(document).Toasts('create', {
                            ...
                            @elseif (session('update'))
                                {{-- <p class="alert alert-success text-center alert-dismissible">{{ session('updatedesig') }}
                                </p> --}}
                                <script>
                                    $(document).ready(function () {
                                        $(document).Toasts('create', {
                            ...
                            @elseif (session('deletedesig'))
                                {{-- <p class="alert alert-success text-center alert-dismissible">{{ session('deletedesig') }}
                                </p> --}}
                                <script>
                                    $(document).ready(function () {
                                        $(document).Toasts('create', {
                                                ...
                                                <li>
                                                    <a href="#" onclick="openChat({{ $user->id }}, '{{ $user->name }}')">
                                                        ...
                                                        <span class="user-name">{{ $user->name }}</span><span
                                                            class="badge badge-secondary user-status" style="margin-left: 4px;"
                                                            id="status-{{ $user->id }}">Offline</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                        </ul>
